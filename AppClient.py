...
class AppClient:
    ...
    #     variable = request.variables.add()
    #     variable.name = name
    #     joint_values = [a1, a2, a3, a4]
    #     variable.position.robot_joints.joints.extend(joint_values)
    ...
    def SetPositionVariable(
        ...
        # Set external joints if necessary
        variable.position.external_joints.extend([e1, e2, e3])
